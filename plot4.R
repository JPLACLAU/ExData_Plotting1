...
#  Date and Time vars from characters into objects of type Date and POSIXlt respectively
...
# plot function that calls different plot functions to build the 4 plots that form the graph
with(subpower,{
